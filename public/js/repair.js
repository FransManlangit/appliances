$(document).ready(function () {
    ...
    var validationRepairCreate = $("#rpform").validate({
        rules: {
        ...
        messages: {
            ...
            uploads: "Image is Required ",
        },
    });

    var validationRepairUpdate = $("#ayform").validate({
        rules: {
            description: { required: true },
            type: { required: true },
            price: { required: true },
